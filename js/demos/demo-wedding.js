...
(function( $ ) {
	...
	*/
	...
	Countdown
	*/
	$('#clock').countdown('2019/01/20 12:00:00').on('update.countdown', function(event) {
		var $this = $(this).html(event.strftime(''
			+ '<span style="color:red">%D<span style="color:red;">day%!d</span></span> '
			+ '<span style="color:red">%H<span style="color:red">hours</span></span> '
			+ '<span style="color:red">%M<span style="color:red">minutes</span></span> '
			+ '<span style="color:red">%S<span style="color:red">seconds</span></span> '
		));
	});
	...
	*/
	...
	Guestbook Form
	*/
	$('#guestbookSendMessagesss').validate({
